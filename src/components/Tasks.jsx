...
const Tasks = ({ selectedTab }) => {
    ...
    const addNewTask = (text, date) => {
        const newTaskItem = { 'text':text, 'date': date || new Date() }
    ...
    return (
        <div className="tasks">
            ...
            {selectedTab === 'INBOX' ? <div className="add-task-btn" onClick={() => { showAddTask ? setShowAddTask(false) : setShowAddTask(true) }}>
